...
biến môi trường `QDRANT_API_KEY`, không ghi secret vào repository; runner sẽ từ
chối API key rỗng. Trước khi chạy, máy phải có ít nhất 8 GB RAM khả dụng; runner dừng trước khi tạo collection
...
rồi ghi kết quả chi tiết vào đường dẫn tạm do người chạy truyền qua `-OutputPath`
(khuyến nghị đặt tên theo hostname/thời gian); phải ghi SHA-256 vào session log
mới trước khi dọn file.
...
Owner phê duyệt thay đổi baseline.
