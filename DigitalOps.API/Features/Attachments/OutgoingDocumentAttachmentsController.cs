...
[ApiController]
[Route("api/v1/outgoing-documents/{outgoingDocumentId:guid}/attachments")]
[Authorize(Policy = AuthorizationPolicies.Drafter)]
public sealed class OutgoingDocumentAttachmentsController(
    IAttachmentService attachmentService) : ControllerBase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var result = await attachmentService.UploadOutgoingAsync(
            outgoingDocumentId,
            claims.StaffId,
            stream,
